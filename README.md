...
La aplicación utiliza **Google Books API** como fuente principal de información sobre libros y **Open Library** como fuente complementaria para los datos de autores, realizando un *cross-reference* entre ambas fuentes para enriquecer la información.

La comunicación entre microservicios utiliza **RabbitMQ** mediante eventos, mientras que **CQRS** permite separar las operaciones de lectura y escritura. **Redis** se utiliza, entre otros casos, para implementar mecanismos de *rate limiting*.
